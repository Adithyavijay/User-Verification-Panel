...
import { Auth, RecaptchaVerifier, signInWithPhoneNumber, User, ConfirmationResult } from "firebase/auth";
import { toast, Toaster } from "react-hot-toast";
import styles from './MobileRegistration.module.css';
...
const MobileRegistration: React.FC = () => {
  ...
  async function onSignup() {
    ...
    setLoading(true);
    try {
      onCaptchVerify(); // Ensure reCAPTCHA is set up
